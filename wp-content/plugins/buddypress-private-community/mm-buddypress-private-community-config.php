 ...
 */ 
MM_BUDDYPRESS_PRIVATE_COMMUNITY::$WP_SUB_FOLDER	 				= 'ctgps';
 ...
 */
MM_BUDDYPRESS_PRIVATE_COMMUNITY::$NOT_ALLOWED_URIS		= Array('/members*');
/**
 ...
 */ 
MM_BUDDYPRESS_PRIVATE_COMMUNITY::$REDIRECT_TO_URL		= site_url().'/warning';
/**
